...
$count=0;
$result=mysql_query("SELECT COUNT(*) AS count FROM dependencias ".$filters,$conexion);
if($result==true)
{
...
$SQL = "SELECT * FROM  dependencias $filters ORDER BY $sidx $sord LIMIT $start,$limit"; 
...
while($row = mysql_fetch_array($result,MYSQL_ASSOC)) {
    $s .= "<row id='". $row['Iddependencia']."'>";            
    $s .= "<cell>". $row['Iddependencia']."</cell>";
