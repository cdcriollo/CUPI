...
$(function(){ 
  ...
  $("#list").jqGrid({
    url:'forms/Dependencias/AdminDependencias/queryDependencias.php',
    datatype: 'xml',
    mtype: 'POST',
    colNames:['Id','Descripción'],
    colModel :[ 
      {name:'Iddependencia', index:'Iddependencia', width:80, editable:false, editoptions:{size:10},editrules:{required:true}}, 
    ...
    rowNum:10,
    rowList:[10,20,30],
    sortname: 'Iddependencia',
    sortorder: 'asc',
    viewrecords: true,
    caption: 'Dependencias',
	width:700,
	height:300,
	editurl:"forms/Dependencias/AdminDependencias/server.php"
   }); 
  $("#list").navGrid('#pager',{	  
	  view:true,
	  del:true,
