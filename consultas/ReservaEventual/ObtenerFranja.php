...
$query_JRFranja = "SELECT idHorario,codDia,horainicio,horafinal,sala FROM horario WHERE codAsignatura='$codigo' AND codGrupo=$grupo and No_reserva='$reserva' and estadohorario='activo'";
...
<body>		
  ...
  <?php  if ($totalfranjas > 0)  
   {?>  
	 <?php echo '<script type="text/javascript">$(".tableUI").styleTable();</script> '; ?>
	  ...
	  <table border="1" width="500" cellpadding="0" cellpadding="0" class="tableUI" style="margin-top:10px; margin-bottom:10px; margin-left:10px;">
      <tr>
         <th></th>
        <th>Dia</th>
        <th>Hora Inicio</th>
 ...
 {
	echo'<script type="text/javascript">alertas("Por favor verifique que la reserva exista, o que la asignatura tenga una programación","Matricula Reserva Eventual","error"); </script>'; 
 }
