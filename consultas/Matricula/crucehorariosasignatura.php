...
$cruce_no=0;
	...
	$query_JRCruceh = "select m.codAsignatura, m.grupo, h.horainicio, h.horafinal,h.codDia,h.sala, h.fechaInicio, h.fechaFinal from matricula m  inner join horario h on(m.idHorario= h.idHorario) where codUsuario=$usuario and m.codAsignatura NOT IN('$asignatura') and m.Estado='Activa'";
   ...
   }// cierro totalRows_JRHasignatura
