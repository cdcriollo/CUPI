 ...
 if(isset($_POST['sala'], $_POST['asignatura'], $_POST['grupo'],$_POST['reserva']))
 {
  ...
  <html>
   ...
   <tr>
    ...
    <tr>
      <td><input type="checkbox" value="<?php echo $row_JRListapc['Nopc'];?>" class="selectpcuser"></td>
	  ...
	  {
	   echo'<script type="text/javascript">alertas("No hay computadores disponibles para el cambio","Modificar Matricula Usuario","error");</script>      ';
	  }
    }
	
	else 
	  {
	    echo'<script type="text/javascript">alertas("La asignatura no ha sido matriculada o se encuentra inactiva","Modificar Matricula Usuario","error");</script>      ';
	  }
 ?>
