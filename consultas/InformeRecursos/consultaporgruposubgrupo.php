...
$query_JRCGrupoRecurso = "select count(Noinventario) as totalrecursos from recursos where idTipo=$idTipo and subGrupo=$subtipo and estadorecurso <> 'Inactivo'";
...
mysql_select_db($database_conexion, $conexion);
$query_JRCPrestadosRecursos = "select COUNT(Noinventario)as prestados from recursos where idTipo=$idTipo and subGrupo=$subtipo  and estadoprestamo='Prestado'";
mysql_query("SET NAMES 'utf8'");
