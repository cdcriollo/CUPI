...
$query_JRCGrupoRecurso = "select count(Noinventario) as totalrecursos, Nombrebien from recursos where idTipo=$idTipo and subGrupo=$subtipo and Noinventario=$inventario";
...
mysql_select_db($database_conexion, $conexion);
$query_JRCPrestadosRecursos = "select COUNT(Noinventario)as prestados from recursos where idTipo=$idTipo and subGrupo=$subtipo and Noinventario=$inventario  and estadoprestamo='Prestado'";
mysql_query("SET NAMES 'utf8'");
