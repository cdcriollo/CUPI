...
if(isset($_POST['idTipo'], $_POST['subgrupo']))
{
	$idTipodetalle= $_POST['idTipo'];
	$idSubgrupodetalle= $_POST['subgrupo'];
	
	
	mysql_select_db($database_conexion, $conexion);
	$query_JRDetalleRecursoGrupo = "SELECT Noinventario, estadorecurso, caracteristicas, estadoprestamo, novedades,cantidad,Nombrebien FROM recursos WHERE idTipo = $idTipodetalle and subGrupo=$idSubgrupodetalle";
