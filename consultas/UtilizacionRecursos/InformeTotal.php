...
<?php 
 ...
 if($horaI!="Null" && $horaF!="Null")
 {
	 ...
	 <table class="Utilizacion" id="Utilizacion" cellspacing="0"  cellpadding="0" width="600" >
      ...
      <tr>
       <td colspan="8" <?php echo $stylecabeceratitulo; ?>> <center><p>INFORME DE UTILIZACIÓN DE RECURSOS DEL PISO INFORMATICO </p></center> </td>
      </tr>
         
         
     <tr>
        <th <?php echo $styleth;?> colspan="2">Desde</th>
       ...
       <tr>
        <td <?php echo $styletr; ?> colspan="2"><?php echo $desde ?> </td>
     ...
     <tr>
      <th <?php echo $styleth; ?>>Actividad </th>
       ...
       <th <?php echo $styleth; ?>>Equipos Prestados</th>
       <th<?php echo $styleth; ?>>Cantidad</th> 
       <th<?php echo $styleth; ?>>Total Horas</th> 
     </tr>  
	...
	<?php 
          ...
          // inicializo los valores para el calculo de las horas y los usuarios 
			...
			// Hago una consulta a la tabla prestamos de recursos
			  mysql_select_db($database_conexion, $conexion);
			 $query_JRCUtilizacion ="select distinct i.sala,i.actividad,i.dependencia,i.estamento,d.descripcion from prestamorecursos p inner join ingreso_salida i on p.codIngreso=i.codIngreso inner join detalle_prestamo d on p.idPrestamo=d.idPrestamo where p.fechaprestamo BETWEEN '$nuevaFechai' and '$nuevaFechaf' and horaentrega 
			 >='$horainicial' and horarecibido <='$horafinal' and p.horarecibido <> '00:00:00' order by i.sala, i.actividad, i.dependencia,i.estamento ";	
		...
		<?php if($totalrowsutilizacion > 0) {?>	
		   ...
		   <?php do{?>	
			  ...
			  <td <?php echo $styletr; ?>><?php echo $row_JRCUtilizacion['descripcion']; ?></td>
             ...
             <?php 
			  ...
			  $descripcionrecurso= $row_JRCUtilizacion['descripcion'];
			  
			  mysql_select_db($database_conexion, $conexion);
			  $query_JRHorasusuarios = "select i.sala,i.actividad,i.dependencia,i.estamento,p.horaentrega,p.horarecibido, d.cantidad,d.descripcion from prestamorecursos p inner join ingreso_salida i on p.codIngreso=i.codIngreso inner join detalle_prestamo d on p.idPrestamo=d.idPrestamo where p.fechaprestamo BETWEEN '$nuevaFechai' and '$nuevaFechaf' and horaentrega >='$horainicial' and horarecibido <='$horafinal' and sala=$sala and actividad='$actividad' and dependencia='$dependencia'  and estamento='$estamento' and descripcion='$descripcionrecurso' and p.horarecibido <> '00:00:00' order by i.sala, i.actividad, i.dependencia,i.estamento ";
			  ...
			  do{
			    ...
			    if($totalRows_JRHorasusuarios > 0)
				{
				    ...
				    $hora1=$row_JRHorasusuarios['horaentrega'];
					$hora2=$row_JRHorasusuarios['horarecibido'];
            ...
            <?php if($totalRows_JRHorasusuarios > 0)
		     {?>
			  <td <?php echo $styletr; ?>> <?php echo $totalrecursos;?></td>
 ...
 <body>
	...
	<?php 
          ...
          // inicializo los valores para el calculo de las horas y los usuarios 
			...
			// Hago una consulta a la tabla prestamo de recursos
			 mysql_select_db($database_conexion, $conexion);
			 $query_JRCUtilizacion ="select distinct i.sala,i.actividad,i.dependencia,i.estamento,d.descripcion from prestamorecursos p inner join ingreso_salida i on p.codIngreso=i.codIngreso inner join detalle_prestamo d on p.idPrestamo=d.idPrestamo where p.fechaprestamo BETWEEN '$nuevaFechai' and '$nuevaFechaf' and p.horarecibido <> '00:00:00' order by i.sala, i.actividad, i.dependencia,i.estamento ";	
			 mysql_query("SET NAMES 'utf8'");
			 $JRCUtilizacion = mysql_query($query_JRCUtilizacion , $conexion) or die(mysql_error());
			 $row_JRCUtilizacion = mysql_fetch_assoc($JRCUtilizacion);
			 $totalrowsutilizacion= mysql_num_rows($JRCUtilizacion);?>
		...
		<?php if($totalrowsutilizacion > 0) {?>		 
		   ...
		   <?php do{?>	
             ...
             <?php 
			  ...
			  mysql_select_db($database_conexion, $conexion);
			  $query_JRHorasusuarios = "select i.sala,i.actividad,i.dependencia,i.estamento,p.horaentrega,p.horarecibido, d.cantidad,d.descripcion from prestamorecursos p inner join ingreso_salida i on p.codIngreso=i.codIngreso inner join detalle_prestamo d on p.idPrestamo=d.idPrestamo where p.fechaprestamo BETWEEN '$nuevaFechai' and '$nuevaFechaf' and sala=$sala and actividad='$actividad' and dependencia='$dependencia'  and estamento='$estamento' and descripcion='$descripcionrecurso' and p.horarecibido <> '00:00:00' order by i.sala, i.actividad, i.dependencia,i.estamento ";
			  $JRHorasusuarios = mysql_query($query_JRHorasusuarios, $conexion) or die(mysql_error());
			  $row_JRHorasusuarios = mysql_fetch_assoc($JRHorasusuarios);
			  $totalRows_JRHorasusuarios = mysql_num_rows($JRHorasusuarios);
