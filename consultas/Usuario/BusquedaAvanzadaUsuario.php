...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
 ...
 //GET SEARCH FIELD ;D
	...
	$query_JRBusquedaAUsuario = "SELECT * FROM usuarios $filters order by $searchfield";
...
<table border="1" cellspacing="0"  class="tableUI" width="600" >
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_JRBusquedaAUsuario['codUsuario']; ?></td>
      <td><?php echo $row_JRBusquedaAUsuario['apellidos']; ?></td>
      <td><?php echo $row_JRBusquedaAUsuario['nombreUsu']; ?></td>
      <td><?php echo $row_JRBusquedaAUsuario['estamento']; ?></td>
      <td><?php echo $row_JRBusquedaAUsuario['dependencia']; ?></td>
