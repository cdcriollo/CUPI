  ...
  <div class="content" id="contenedor" style="padding-top:20px; padding-bottom:20px;">
     ...
     <div style="height:380px; width:960px; margin-right:auto; margin-left:auto;"> 
       ...
       <div style="width:360px; float:right; padding-top:80px; padding-right:20px; text-justify:auto;"> 
        ...
        <p style="font-size:18px; text-align:left; color:#203360; font-weight:bold;">Bienvenido a CUPI, esta aplicacíon ha sido desarrollada para facilitar las labores que están relacionadas con el manejo del piso informatico de la facultad de artes integradas de la Universidad del Valle.</p>&nbsp;
        ...
        <table>
             ...
             <tr>
             <td style="font-size:14px; font-weight:bold"><center>Administrador</center></td>
             <td style="font-size:14px; font-weight:bold"><center>Operario</center></td>
             </tr>
         </table> 
        </center>
   ...
   <div class="footer" style="text-align:center">
     ...
     <p style="color:#FFF; padding-top:20px;">@ 2011 Cupi</p> 
