     ...
     <div style="height:380px; width:960px; margin-right:auto; margin-left:auto;"> 
       ...
       <div style="width:360px; float:right; padding-top:80px; padding-right:20px; text-justify:auto;"> 
        ...
        <table>
		 ...
		 <td><a href="logearse.php?height=180&amp;width=360&amp;&nameuser=Coordinador" rel="sexylightbox" style="text-decoration:none;" ><center><img src="images/coordPerfil.png" style="vertical-align:middle; padding-right:5px;"/></center> </a></td>
		 ...
		 <td style="font-size:14px; font-weight:normal"><center>Coordinador</center></td>
